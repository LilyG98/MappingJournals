...
# def TRY_Extract_longlat_WikiData (List_Q_code):
#     """ESSAI Extraire L'ENSEMBLE des coordonnées des lieux de la base de données GPH via l'API de Wikidata.
#         La fonction retourne un df avec Q_code+lat+long
#         Et  créé un csv dans le output_path indique
#     """
#     list_lat=[]
#     list_long=[]
...
#             if "P625"in q_dict["claims"] : #Si le Q_code a bien des coordonnées géo 
